...
export default function Header() {
  ...
  return (
    <div className={`${styles.header} bg-gradient-to-r from-cyan-500 to-blue-500 h-50 flex py-4 justify-between font-sans`}>
        <div className=""><Image width={60} height={60} src={'/logo.png'}   /></div>
      <nav className="basis-1/3 flex gap-8 justify-center justify-self-center font-bold text-lg mr-16 text-black">
